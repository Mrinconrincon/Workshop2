...
console.log(param8.slice(0,param8.length-6))
console.log(`${param8.slice(0,param8.length-6)}${1}.png`)
...
imageContainer.style.backgroundImage = `url(${param8})`
thumbnails.forEach(thumbnail => {
    thumbnail.addEventListener('click', event => {
        console.log(event.target.id)
        imageContainer.style.backgroundImage = `url('${param8.slice(0,param8.length-6)}${event.target.id.slice(-1)}.png')`
    });
});
...
modalImageContainer.style.backgroundImage = `url(${param8})`
modalthumbnails = [...modalthumbnails]

modalthumbnails.forEach(modalthumbnail => {
    modalthumbnail.addEventListener('click', event => {
        console.log(event.target.id.slice(-1))
        modalImageContainer.style.backgroundImage = `url('${param8.slice(0,param8.length-6)}${event.target.id.slice(-1)}.png')`
    });
});
...
function changeNextImage(imgContainer) {
    ...
    imgContainer.style.backgroundImage = `url('${param8.slice(0,param8.length-6)}${imgIndex}.png')`
}
